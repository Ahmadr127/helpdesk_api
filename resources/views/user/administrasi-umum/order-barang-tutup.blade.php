...
@section('title', 'Permintaan Barang - Ditutup')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 bg-gradient-to-r from-violet-600 to-violet-400 rounded-lg p-6 shadow-sm">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="mt-2 text-sm text-white">Daftar order yang telah ditutup / menunggu konfirmasi selesai</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            <button id="filterDate"
                                class="w-full px-4 py-2 bg-violet-600 text-white text-sm font-medium rounded-lg hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <div id="emptyState" class="hidden p-12 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak Ada Order Ditutup</h3>
                <p class="text-gray-500">Belum ada order berstatus ditutup saat ini</p>
            </div>
...
async function refreshOrderList() {
    try {
        const response = await fetch('{{ route("user.administrasi-umum.order-barang.tutup") }}', {
            headers: {
...
document.getElementById('filterDate').addEventListener('click', async function() {
    ...
    try {
        const response = await fetch(
            `{{ route('user.administrasi-umum.order-barang.tutup') }}?start_date=${startDate}&end_date=${endDate}`, {
                headers: {
                    'Accept': 'application/json',
                    'X-Requested-With': 'XMLHttpRequest'
                }
