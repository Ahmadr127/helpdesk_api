            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-searchable-select name="position" :options="$positions" :selected="old('position', $user->position)" placeholder="Cari position..." :required="true" />
                        @error('position')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Leave blank to keep current password. Password must be minimum 3 characters.</p>
                        @error('password')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="password_confirmation" minlength="3"
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-green-100 focus:border-green-400 transition-colors">
                    ...
                    <div>
                        ...
                        <x-searchable-select name="department" :options="$departments" :selected="old('department', $user->department)" placeholder="Cari department..." :required="true" />
                        @error('department')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
