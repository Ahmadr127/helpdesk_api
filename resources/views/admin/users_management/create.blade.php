        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Username <span class="text-xs text-gray-500">(untuk login)</span></label>
                        <input type="text" name="username" value="{{ old('username') }}" placeholder="Kosongkan auto dari email"
