...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div
            class="bg-white -mx-6 -mt-6 px-6 py-4 mb-6 border-b border-gray-200 rounded-t-lg">
        ...
        <!-- Filters -->
        <div class="mb-6">
            <form id="filterForm" action="{{ route('admin.order-perbaikan.rejected') }}" method="GET"
                class="bg-gray-100 p-4 rounded-lg border border-gray-200 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
