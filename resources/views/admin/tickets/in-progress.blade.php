...
@section('title', 'Tiket Dalam Proses')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
        <div class="bg-gradient-to-r from-white to-blue-300 p-5">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Tiket Dalam Proses</h2>
                    <p class="text-sm text-gray-600 mt-1">Tiket yang sedang ditangani</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-100">
        <form action="{{ route('admin.tickets.in-progress') }}" method="GET" class="space-y-4">
