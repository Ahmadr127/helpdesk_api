    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6 border border-gray-100">
        <form id="filterForm" action="{{ route('admin.master.unit-proses.index') }}" method="GET"
            ...
            <div class="md:col-span-4">
                ...
                <x-searchable-select name="search" :options="$searchOptions ?? []" :selected="request('search')" placeholder="Cari berdasarkan nama atau kode unit proses…" id="filter_search" />
            </div>
            <div>
            ...
            <div class="flex items-end space-x-2">
                ...
                <button type="button" onclick="openModal()"
                    class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-all shadow-sm">Add Unit Proses</button>
            </div>
        </form>
    </div>
