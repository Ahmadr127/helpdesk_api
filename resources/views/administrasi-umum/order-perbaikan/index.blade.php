        ...
        <div class="p-5">
            <form id="filterForm" action="{{ route('administrasi-umum.order-perbaikan.index') }}" method="GET"
                ...
                <div class="md:col-span-3 lg:col-span-6 flex justify-end">
                    <button type="submit"
                        class="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium py-2.5 px-5 rounded-lg transition duration-150 ease-in-out inline-flex items-center shadow-md">
