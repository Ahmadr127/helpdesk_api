...
@section('title', 'Detail Order Perbaikan Ditolak')

@section('content')
<div class="container mx-auto px-4 py-8 max-w-8xl">
    <!-- Back button and status badge -->
    <div class="flex justify-between items-center mb-6">
        <a href="{{ route('administrasi-umum.order-perbaikan.rejected') }}"
        ...
        <span class="px-4 py-2 text-sm font-medium rounded-full bg-red-100 text-red-800 flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
        ...
        <div class="p-8">
            ...
            <div class="mt-10 border-t border-blue-100 pt-8">
                <h3 class="text-xl font-medium text-blue-800 mb-6">Alasan Penolakan</h3>
                <div class="bg-red-50 rounded-lg p-6 border border-red-100">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-red-700 mb-2">Follow Up</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-red-700 mb-2">Ditolak Oleh</label>
